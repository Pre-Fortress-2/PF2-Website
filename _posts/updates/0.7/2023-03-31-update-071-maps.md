...
The new control point model was discovered by Kristofer, one of our devs, within the January TF2 Leaks. We believe that this model was used for the beta hologram. I made the model and textures based off the retail textures/model. The model is currently only in Trainyard and Bridge and will potentially be expanded to other maps in the future.
