...
> This update has an immense amount of changes if you're interested in a more in depth look on grenades, the new menu, or a preview of our maps, view the links below.
...
- Added ability to disarm grenades by striking them with a melee or firing a weapon at it
  ...
  - Firing a weapon once at Frag and Caltrop grenades, will disarm it
  - Firing a weapon twice at Special grenades
...
- Added a flamethrower alt-fire muzzle flash effect
- Added a charge mechanic to the flamerocket. 
	- Charging it increases both the distance and damage
...
- Increased Heavy's armor from 200 to 225
...
- Added a grenade pin pull sound
...
- Goldrush (PL)
  ...
  - Features final point from Badwater
- Badlands (CP)
...
{% include achievement.html ach_image="/assets/achievements/question_mark.png" ach_name="+1 Hidden Achievement" ach_desc=""%}
