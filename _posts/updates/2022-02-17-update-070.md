...
<blockquote>Primarily need to work on the following 3 sections</blockquote>
...
- Updated the codebase to use the v142/v143 toolset/C++17 (From [SDK2013CE](https://github.com/Nbc66/source-sdk-2013-ce))
...
## Achievements
{% include achievement.html ach_image="/assets/achievements/pf_nade_multi_heal_player.png" ach_name="Special kind of Medicine " ach_desc="Heal 3 teammates or more with one heal grenade"%}
{% include achievement.html ach_image="/assets/achievements/pf_fatfingers.png" ach_name="Fat fingers" ach_desc="Remotely kill a spy by detonating a dispenser or a teleporter" %}
{% include achievement.html ach_image="/assets/achievements/pf_bonk_by_nade.png" ach_name="Heads up" ach_desc="Kill a player with any grenade by direct impact"%}
