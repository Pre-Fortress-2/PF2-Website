...
- Updated tc_hydro to fix some Engineer exploit spots
...
- Redid Heavy's and Spy's grenade viewmodel animations (Thanks DR_Seal)

{%include video.html video="\assets\blog\update-071-updatepage\grenadeshowcase.mp4" text="Animations in 54 and 70 viewmodel FOV respectively" %}
	
- Redid the Scout Concussion Grenade viewmodel animations
...
- Redid the Pyro Napalm Grenade viewmodel animations
...
- Updated the coordinates of the Soldier Memorial Statue on some maps
