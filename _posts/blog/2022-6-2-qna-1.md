...
> Will you remove the slowing effect of the tranq dart? It's one of the worst things than can be done to a game like Team Fortress.

- Tranq dart has gone through a lot of development to get to where it is today. It will remain a part of PF2's identity and is not leaving. 

    In 0.7 we nerfed the tranq so when the it's fired from far away the victim is slowed down for less amount of time. But the closer victim is, the longer the victim is slowed.

> Will the unique voice lines be restored since you're moving away from being entirely beta-accurate?

- We're restoring the unique voice lines as their absence negatively impacted the playability of the game. It made it a lot harder or impossible to quickly communicate certain messages such as calling out a spy or an upcoming sentry. We've left in the beta death screams as we enjoy their charm.

> Will the Silenced Pistol be reconsidered down the long run?

- Other weapons have and continue to be considered, the silenced pistol is a weird one though. It was is in a piece of concept art that has the spy holding it. In TFC however the model for the tranq is a silenced pistol, meaning it was likely meant to be a tranq in that concept art.
...
- We expect bots to be a part of PF2 in the 0.8 update. It has been a priority for some time but finding a dedicated developer has been tricky since we didn't reuse TF2's code.
...
- To name a few repeated item requests; the repair node, fire retardant suit, DNA gun, the walkabout, the catcher's mit and the overhealer were designed after TF2's release. They will not be featured in our game.

> Will you add the civilian/escort gamemode, 4-team and other concepts from from TFC?

- Adding the civilian/escort and 4-team gamemode is still up in the air, likely as a way to support existing community maps. The primary reason against the inclusion of these is because we don't really have anything to bring to these gamemodes that isn't done better elsewhere, other than the inclusion of grenades. 
